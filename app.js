...
function digitando() {//Função,acionada, ao começar a digitar...
    ...
    document.getElementById("__mensagem2").innerHTML = 'Aguarde!';//altera os textos, ao acionar a Função.
}
...
function criptografar() {//acionada, quando clica o button...
    ...
    digitando();//chamada da função...
    
    let codificador = { 'a': 'ai', 'e': 'enter', 'i': 'imes', 'o': 'ober', 'u': 'ufat' };
    //criando um array com as mensagens,onde cada uma já tem seu valor trocado
